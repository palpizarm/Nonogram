...
public class HorizontalClues : MonoBehaviour
{
    ...
    {
        rows = reader.getRows();
        clues = reader.getRowsHints();
        height = parent.GetComponent<RectTransform>().sizeDelta[1] / rows;
        ...
        for (int row = 0; row < rows; row++)
        {
            ...
            textUI.GetComponent<RectTransform>().sizeDelta = new Vector2(100f, 21.5f);
        }
    }
}
